      ...
      <v-card class="rounded">
        ...
        <v-card-text v-if="tab === 1">
          <h3 class="text-secondary">
            <strong>{{ t('text.abouttext.p1') }} {{ version }}</strong>
          </h3>
          <p>
            <strong>{{ t('text.abouttext.p2') }}</strong
            ><br /><br />
          </p>
          <p>
            <strong>{{ t('text.abouttext.p3') }}</strong>
          </p>
          <p>{{ t('text.abouttext.p4') }}<br /><br /></p>
          <p>
            <strong>{{ t('text.abouttext.p5') }}</strong>
          </p>
          <p>
            <a
              href="https://github.com/segoja/mass-file-renamer"
              target="_blank"
              rel="noopener noreferrer"
              >https://github.com/segoja/mass-file-renamer</a
            >
          </p>
        ...
        <v-card-text v-if="tab === 2">
          <ol class="px-4 pb-4">
            <li>{{ t('text.helptext.p1') }}</li>
            <li>{{ t('text.helptext.p2') }}</li>
            <li>{{ t('text.helptext.p3') }}</li>
            <li>{{ t('text.helptext.p4') }}</li>
            <li>{{ t('text.helptext.p5') }}</li>
            <li>{{ t('text.helptext.p6') }}</li>
            <li>{{ t('text.helptext.p7') }}</li>
            <li>{{ t('text.helptext.p8') }}</li>
          </ol>
        </v-card-text>
        <v-card-actions>
